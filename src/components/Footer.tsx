        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              {["Home", "About", "Events", "Register", "FAQs", "Contact"].map((item, index) => (
                <li key={index}>
                  <a 
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex">
                ...
                <span>14 Abovyan St, Yerevan, Armenia</span>
              </li>
              <li className="flex">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-arc-yellow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>info@armenianrobotics.am</span>
              </li>
              <li className="flex">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-arc-yellow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-arc-yellow text-arc-dark px-4 py-2 rounded-r-md hover:bg-amber-400 transition-colors"
              >
